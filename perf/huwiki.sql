...
) AS MultimediaViewerNetworkPerformanceUnioned WHERE wiki = 'huwiki' AND timestamp IS NOT NULL AND event_type = 'userinfo' GROUP BY datestring ORDER BY datestring ASC ) userinfo_stats USING (datestring) ) date_userinfo
...
UNION ALL
SELECT event_type, event_total, timestamp, wiki FROM MultimediaViewerNetworkPerformance_7917896
) AS MultimediaViewerNetworkPerformanceUnioned WHERE wiki = 'huwiki' AND timestamp IS NOT NULL AND event_type = 'imageinfo' GROUP BY datestring ORDER BY datestring ASC ) imageinfo_stats USING (datestring) ) date_userinfo_imageinfo
...
UNION ALL
SELECT event_type, event_total, timestamp, wiki FROM MultimediaViewerNetworkPerformance_7917896
) AS MultimediaViewerNetworkPerformanceUnioned WHERE wiki = 'huwiki' AND timestamp IS NOT NULL AND event_type = 'thumbnailinfo' GROUP BY datestring ORDER BY datestring ASC ) thumbnailinfo_stats USING (datestring) ) date_userinfo_imageinfo_thumbnailinfo
...
UNION ALL
SELECT event_type, event_total, timestamp, wiki FROM MultimediaViewerNetworkPerformance_7917896
) AS MultimediaViewerNetworkPerformanceUnioned WHERE wiki = 'huwiki' AND timestamp IS NOT NULL AND event_type = 'filerepoinfo' GROUP BY datestring ORDER BY datestring ASC ) filerepoinfo_stats USING (datestring) ) date_userinfo_imageinfo_thumbnailinfo_filerepoinfo
...
UNION ALL
SELECT event_type, event_total, timestamp, wiki FROM MultimediaViewerNetworkPerformance_7917896
) AS MultimediaViewerNetworkPerformanceUnioned WHERE wiki = 'huwiki' AND timestamp IS NOT NULL AND event_type = 'imageusage' GROUP BY datestring ORDER BY datestring ASC ) imageusage_stats USING (datestring) ) date_userinfo_imageinfo_thumbnailinfo_filerepoinfo_imageusage
...
UNION ALL
SELECT event_type, event_total, timestamp, wiki FROM MultimediaViewerNetworkPerformance_7917896
) AS MultimediaViewerNetworkPerformanceUnioned WHERE wiki = 'huwiki' AND timestamp IS NOT NULL AND event_type = 'globalusage' GROUP BY datestring ORDER BY datestring ASC ) globalusage_stats USING (datestring) ) date_userinfo_imageinfo_thumbnailinfo_filerepoinfo_imageusage_globalusage
...
UNION ALL
SELECT event_type, event_total, timestamp, wiki FROM MultimediaViewerNetworkPerformance_7917896
) AS MultimediaViewerNetworkPerformanceUnioned WHERE wiki = 'huwiki' AND timestamp IS NOT NULL AND event_type = 'image' GROUP BY datestring ORDER BY datestring ASC ) image_stats USING (datestring) ) date_userinfo_imageinfo_thumbnailinfo_filerepoinfo_imageusage_globalusage_image
